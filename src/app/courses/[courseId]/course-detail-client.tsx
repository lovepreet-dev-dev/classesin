...
import { ArrowDown, ArrowLeft, ArrowUp, Archive, CheckCircle2, Circle, Edit3, Loader2, MessageSquare, Plus, RotateCcw, Send, Trash2, UserPlus, X } from "lucide-react";
...
type Props = { course: Course; enrollment: { id: string; progress: string } | null; completedLessonIds: string[]; viewerRole: "instructor" | "learner" | null; learners: Learner[]; activities?: Activity[]; demoMode?: boolean };
...
export default function CourseDetailClient({ course: initialCourse, enrollment: initialEnrollment, completedLessonIds, viewerRole, learners, activities: initialActivities = [], demoMode = false }: Props) {
